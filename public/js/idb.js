...
let db;
// establish a connection to IndexedDB database called 'pending' and set it to version 1
...
request.onsuccess = function (event) {
  ...
  //  if app is online, if yes run uploadRecord() function to send all local db data to api
  if (navigator.onLine) {
...
function saveRecord(record) {
  ...
  // access the object store for `store`
